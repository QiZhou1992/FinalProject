class PrivateAlbumImagesController < ApplicationController
  before_action :set_private_album_image, only: [:show, :edit, :update, :destroy]

  # GET /private_album_images
  # GET /private_album_images.json
  def index
    @private_album_images = PrivateAlbumImage.all
  end

  # GET /private_album_images/1
  # GET /private_album_images/1.json
  def show
  end

  # GET /private_album_images/new
  def new
    @private_album_image = PrivateAlbumImage.new
  end

  # GET /private_album_images/1/edit
  def edit
  end

  # POST /private_album_images
  # POST /private_album_images.json
  def create
  ...
  # PATCH/PUT /private_album_images/1
  # PATCH/PUT /private_album_images/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /private_album_images/1
  # DELETE /private_album_images/1.json
  def destroy
